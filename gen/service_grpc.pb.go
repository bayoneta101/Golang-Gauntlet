...
const (
	Greeter_Hello_FullMethodName = "/grpc.Greeter/Hello"
)
...
type GreeterClient interface {
	Hello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Reply, error)
}
...
func (c *greeterClient) Hello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Reply, error) {
...
type GreeterServer interface {
	Hello(context.Context, *Message) (*Reply, error)
...
func (UnimplementedGreeterServer) Hello(context.Context, *Message) (*Reply, error) {
